...
1. Stiahnite si [súbor](https://mirror.cachyos.org/ISO/desktop/250713/cachyos-desktop-linux-250713.iso.sha256) obsahujúci SHA256 hash **(Otvorte ho pomocou textového editora, napr.: Poznámkový blok).**
...
1. Stiahnite si [súbor](https://mirror.cachyos.org/ISO/desktop/250713/cachyos-desktop-linux-250713.iso.sha256) obsahujúci SHA256 hash.
