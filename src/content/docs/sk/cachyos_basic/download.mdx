...
1. Stiahnite si [súbor](https://mirror.cachyos.org/ISO/desktop/250422/cachyos-desktop-linux-250422.iso.sha256) obsahujúci SHA256 hash **(Otvorte ho pomocou textového editora, napr.: Poznámkový blok).**
...
1. Stiahnite si [súbor](https://mirror.cachyos.org/ISO/desktop/250422/cachyos-desktop-linux-250422.iso.sha256) obsahujúci SHA256 hash.
