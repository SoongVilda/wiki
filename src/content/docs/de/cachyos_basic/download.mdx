...
1. Lade die [Datei](https://mirror.cachyos.org/ISO/desktop/250713/cachyos-desktop-linux-250713.iso.sha256) herunter, die den SHA256-Hash enthält **(Öffne sie mit einem Texteditor, z. B. Notepad).**
...
1. Lade die [Datei](https://mirror.cachyos.org/ISO/desktop/250713/cachyos-desktop-linux-250713.iso.sha256) herunter, die den SHA256-Hash enthält.
