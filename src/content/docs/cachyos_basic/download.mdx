...
1. Download the [file](https://mirror.cachyos.org/ISO/desktop/250330/cachyos-desktop-linux-250330.iso.sha256) containing the SHA256 hash **(Open it with a Text Editor e.g: Notepad).**
...
1. Download the [file](https://mirror.cachyos.org/ISO/desktop/250330/cachyos-desktop-linux-250330.iso.sha256) containing the SHA256 hash.
