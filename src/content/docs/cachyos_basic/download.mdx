...
**Current ISO Version:** `250202`

**SHA256 Hash:** `9534246dda6e00fd0bd05aac30d1445873cfe4226507dffc62f2adf42fb7d2e8`
...
1. Download the [file](https://mirror.cachyos.org/ISO/desktop/250202/cachyos-desktop-linux-250202.iso.sha256) containing the SHA256 hash **(Open it with a Text Editor e.g: Notepad).**
...
3. Execute the following command:
   ```powershell
   # Example:
   certUtil -hashfile cachyos-desktop-linux-250202.iso SHA256
   ```
...
1. Download the [file](https://mirror.cachyos.org/ISO/desktop/250202/cachyos-desktop-linux-250202.iso.sha256) containing the SHA256 hash.
2. Open a terminal and navigate to the directory containing the `.sha256` file and execute the following commands:
   ```sh
   # Example:
   cd Downloads/
   cat cachyos-desktop-linux-250202.iso.sha256
...
3. Compare the output from **Step 2** and execute the following command to check what's the current hash in the ISO file.
   ```sh
   # Example:
   sha256sum cachyos-desktop-linux-250202.iso
   ```
...
3. Compare the output from **Step 2** and execute the following command to check what's the current hash in the ISO file.
   ```sh
   # Example:
   shasum -a 256 cachyos-desktop-linux-250202.iso
   ```
4. If the hashes from **Step 2** and **Step 3** match, you can proceed with the CachyOS installation.
