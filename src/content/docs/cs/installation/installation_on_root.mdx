...
7. Dvojitě zkontrolujte, že ***Instalovat boot loader na:*** směřuje na váš boot disk např.: /dev/sda.

8. Vyberte preferované **Desktopové prostředí**, viz [Desktopová prostředí](/installation/desktop_environments).

9. Vyberte konkrétní balíčky, které chcete nainstalovat, a zrušte výběr těch, které nepotřebujete.
