...
1.  Stáhněte [soubor](https://mirror.cachyos.org/ISO/desktop/250713/cachyos-desktop-linux-250713.iso.sha256) obsahující SHA256 hash **(Otevřete jej v textovém editoru, např. Poznámkový blok).**
...
1.  Stáhněte [soubor](https://mirror.cachyos.org/ISO/desktop/250713/cachyos-desktop-linux-250713.iso.sha256) obsahující SHA256 hash.
