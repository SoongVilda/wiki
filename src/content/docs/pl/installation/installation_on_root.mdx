...
7. Sprawdź dokładnie, czy opcja ***Zainstaluj program rozruchowy na:*** wskazuje na twój dysk rozruchowy, np. /dev/sda
...
10. Ustaw swoje dane logowania.

11. Dokładnie przejrzyj podsumowanie instalacji na stronie Przegląd. Jeśli wszystkie ustawienia wyglądają dla ciebie poprawnie, kontynuuj instalację, klikając ***Zainstaluj teraz***. W przeciwnym razie wróć i wprowadź niezbędne zmiany.
