...
1. Загрузите [файл](https://mirror.cachyos.org/ISO/desktop/250422/cachyos-desktop-linux-250422.iso.sha256), содержащий SHA256-хеш **(Откройте его с помощью текстового редактора, например, Блокнота).**
...
1. Загрузите [файл](https://mirror.cachyos.org/ISO/desktop/250422/cachyos-desktop-linux-250422.iso.sha256), содержащий SHA256-хеш.
