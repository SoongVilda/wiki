...
1. Загрузите [файл](https://mirror.cachyos.org/ISO/desktop/250713/cachyos-desktop-linux-250713.iso.sha256), содержащий SHA256-хеш **(Откройте его с помощью текстового редактора, например, Блокнота).**
...
1. Загрузите [файл](https://mirror.cachyos.org/ISO/desktop/250713/cachyos-desktop-linux-250713.iso.sha256), содержащий SHA256-хеш.
